export class AppConstants {
    private static API_BASE_URL = "http://localhost:8080/jewelbankersapi/";
    private static OAUTH2_URL = AppConstants.API_BASE_URL + "social/";
    private static REDIRECT_URL = "?redirect_uri=http://localhost:8080/jewelbankersapi/login";
